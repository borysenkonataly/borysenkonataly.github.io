...
$(function(){function i(){$(".main-head").css("height",$(window).height())}i(),$(window).resize(function(){i()}),(new WOW).init(),$(".main-head").parallax({imageSrc:"img/bg-main.jpg",zIndex:"1"}),$(".toggle-menu").click(function(){$(".sandwich").toggleClass("active")}),$(".top-menu ul a").click(function(){$(".top-menu").fadeOut(600),$(".sandwich").toggleClass("active"),$(".text-disc").css("opacity","1")}),$(".toggle-menu").click(function(){$(".top-menu").is(":visible")?($(".text-disc").css("opacity","1"),$(".top-menu").fadeOut(600),$(".top-menu li a").removeClass("fadeInUp animated")):($(".text-disc").css("opacity","0"),$(".top-menu").fadeIn(600),$(".top-menu li a").addClass("fadeInUp animated"))}),$("input, select, textarea").jqBootstrapValidation(),$(".popup-content").magnificPopup({type:"inline",midClick:!0}),$(".p-item").each(function(i){$(this).find("a").attr("href","#work_"+i),$(this).find(".img-descr").attr("id","work_"+i)}),$(".top-menu ul a").mPageScroll2id()}),$(window).on("load",function(){$(".loader-in").fadeOut(),$(".loader").delay(400).fadeOut("slow"),$(".text-disc h1").addClass("animated fadeInDown"),$(".text-disc p").addClass("animated fadeInUp")});