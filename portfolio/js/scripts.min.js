...
$(function(){function a(){$(".main-head").css("height",$(window).height())}$("#slides").slidesjs({width:1200,height:687,navigation:{active:!1,effect:"fade"},pagination:{active:!1}}),a(),$(window).resize(function(){a()}),(new WOW).init(),$(".main-head").parallax({imageSrc:"img/bg-main.jpg",zIndex:"1"}),$(".toggle-menu").click(function(){$(".sandwich").toggleClass("active")}),$(".top-menu ul a").click(function(){$(".top-menu").fadeOut(600),$(".sandwich").toggleClass("active"),$(".text-disc").css("opacity","1")}),$(".toggle-menu").click(function(){$(".top-menu").is(":visible")?($(".text-disc").css("opacity","1"),$(".top-menu").fadeOut(600),$(".top-menu li a").removeClass("fadeInUp animated")):($(".text-disc").css("opacity","0"),$(".top-menu").fadeIn(600),$(".top-menu li a").addClass("fadeInUp animated"))}),$("input, select, textarea").jqBootstrapValidation(),$(".p-item").each(function(a){$(this).find("a").attr("href","#work_"+a),$(this).find(".img-descr").attr("id","work_"+a)}),$(".top-menu ul a").mPageScroll2id()}),$(window).on("load",function(){$(".loader-in").fadeOut(),$(".loader").delay(400).fadeOut("slow"),$(".text-disc h1").addClass("animated fadeInDown"),$(".text-disc p").addClass("animated fadeInUp")});